...
export type AttachmentKind =
  "image" | "audio" | "video" | "pdf" | "archive" | "code" | "text" | "file";
...
export function attachmentKind(
  ...
  if (
    ...
    /\.(png|jpe?g|gif|webp|bmp|svg|heic|avif)$/.test(name)
  )
    return "image";
  if (
    type.startsWith("audio/") ||
    /\.(mp3|wav|ogg|m4a|opus|flac|aac)$/.test(name)
  )
    return "audio";
  if (type.startsWith("video/") || /\.(mp4|mov|mkv|webm|avi)$/.test(name))
    return "video";
  ...
  if (
    ...
    return "archive";
  if (
    /\.(js|jsx|ts|tsx|py|rs|go|java|kt|c|h|cpp|cs|rb|php|sh|sql|html|css)$/.test(
      name,
    )
  )
    return "code";
        ...
        return (
          ...
          >
            ...
            <span className="attachment-chip__body">
              ...
              {size ? (
                <span className="attachment-chip__size">{size}</span>
              ) : null}
            </span>
            <button
              type="button"
