...
- Made mobile chat startup faster by restoring cached UI state while authoritative Hermes history loads.
- Improved reconnect safety and conversation history refresh behavior.
